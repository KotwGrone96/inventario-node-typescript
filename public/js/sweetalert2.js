...
!(function (t, e) {
						...
						(function (t, e, n, o) {
							...
							K([t, e, n], a.styled),
								o.confirmButtonColor &&
									((t.style.backgroundColor = o.confirmButtonColor), K(t, a['default-outline']));
							o.denyButtonColor &&
								((e.style.backgroundColor = o.denyButtonColor), K(e, a['default-outline']));
							o.cancelButtonColor &&
								((n.style.backgroundColor = o.cancelButtonColor), K(n, a['default-outline']));
						})(o, i, s, n),
						n.reverseButtons &&
							(n.toast
	...
	const ht = (t, e) => {
		...
		n &&
			...
			(function (t, e) {
				...
				e in a
					? K(t, a[e])
					: (d('The "position" parameter is not valid, defaulting to "center"'), K(t, a.center));
			})(n, e.position),
			(function (t, e) {
				if (!e) return;
				K(t, a['grow-'.concat(e)]);
	...
	var gt = { innerParams: new WeakMap(), domCache: new WeakMap() };
			...
			if (!Bt[t.input])
				return void p(
					'Unexpected type of input! Expected '
						.concat(Object.keys(Bt).join(' | '), ', got "')
						.concat(t.input, '"')
				);
			const e = At(t.input),
				n = Bt[t.input](e, t);
	...
	const Et = (t, e) => {
		...
		Ot = (t, e) => {
			...
			(t.className = ''.concat(a.popup, ' ').concat(tt(t) ? n.popup : '')),
				e.toast
					? (K([document.documentElement, document.body], a['toast-shown']), K(t, a.toast))
					: K(t, a.modal),
				R(t, e, 'popup'),
					...
					o && 0 !== o.length && void 0 !== i
						? (J(n),
						  ...
						  o.forEach((t, s) => {
								const r = Mt(t);
								if (
									(n.appendChild(r), s === i && K(r, a['active-progress-step']), s !== o.length - 1)
								) {
									const t = jt(e);
									n.appendChild(t);
								}
		...
		Wt = (t, e, n) => {
			g(e.allowEscapeKey) && (t.preventDefault(), n(Dt.esc));
		};
	...
	const se = (t) => {
			t.isAwaitingPromise && (delete t.isAwaitingPromise, gt.innerParams.get(t) || t._destroy());
		},
		re = (t) =>
			void 0 === t
		...
		de = (t, e) => {
			...
			n &&
				...
				(!e && tt(L()) && (e = L()),
				J(n),
				e && (X(e), o.setAttribute('data-button-to-replace', e.className), n.insertBefore(o, e)),
				K([t, n], a.loading));
		},
		pe = (t) => (t.checked ? 1 : 0),
	...
	const be = (t) => {
		...
		we = (t, e) => {
			...
			if (!n.input)
				return void p(
					'The "input" parameter is needed to be set when using returnInputValueOn'.concat(u(e))
				);
			const o = t.getInput(),
				i = ((t, e) => {
					const n = t.getInput();
	...
	const Qe = (t, e, n) => {
		...
		tn = (t) =>
			!!(t.showConfirmButton || t.showDenyButton || t.showCancelButton || t.showCloseButton);
	let en = !1;
	const nn = (t) => {
			t.popup.onmousedown = () => {
		...
		sn = (t, e, n) => {
			e.container.onclick = (o) => {
				en ? (en = !1) : o.target === e.container && g(t.allowOutsideClick) && n(Dt.backdrop);
			};
		},
		...
		!(function (t) {
			...
			(function (t) {
				(!t.target ||
					...
					(d('Target parameter is not valid, defaulting to "body"'), (t.target = 'body'));
			})(t),
	...
	class jn {
		...
		_main(t) {
			...
			((t) => {
				!1 === t.backdrop &&
					t.allowOutsideClick &&
					d('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`');
			...
			const o = Dn(On);
			return Ht(On, n), gt.innerParams.set(On, n), Hn(On, o, n);
		}
		then(e) {
	...
	const Hn = (t, e, n) =>
		...
		Vn = (t, e) => {
			e.toast || (g(e.allowEnterKey) ? Nn(t, e) || Vt(-1, 1) : Fn());
		},
		Nn = (t, e) =>
			e.focusDeny && tt(t.denyButton)
				...
				: !(!e.focusConfirm || !tt(t.confirmButton)) && (t.confirmButton.focus(), !0),
		Fn = () => {
